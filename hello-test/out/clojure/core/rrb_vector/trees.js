...
var G__2372 = (node__$1.arr[((i__$1 >> shift__$2) & (31))]);
var G__2373 = (shift__$2 - (5));
node__$1 = G__2372;
shift__$2 = G__2373;
continue;
}
...
var G__2375 = i__$2;
var G__2376 = (node.arr[j]);
var G__2377 = (shift__$1 - (5));
i__$1 = G__2375;
node = G__2376;
shift__$1 = G__2377;
continue;
...
var n_2382 = ret;
var shift_2383__$1 = shift;
while(true){
var arr_2384__$1 = n_2382.arr;
var subidx_2385 = (((cnt - (1)) >> shift_2383__$1) & (31));
if((shift_2383__$1 === (5))){
(arr_2384__$1[subidx_2385] = tail_node);
} else {
var temp__5718__auto___2386 = (arr_2384__$1[subidx_2385]);
if(cljs.core.truth_(temp__5718__auto___2386)){
var child_2387 = temp__5718__auto___2386;
var new_carr_2388 = cljs.core.aclone.call(null,child_2387.arr);
var new_child_2389 = cljs.core.__GT_VectorNode.call(null,root_edit,new_carr_2388);
(arr_2384__$1[subidx_2385] = new_child_2389);

var G__2390 = new_child_2389;
var G__2391 = (shift_2383__$1 - (5));
n_2382 = G__2390;
shift_2383__$1 = G__2391;
continue;
} else {
(arr_2384__$1[subidx_2385] = clojure.core.rrb_vector.trees.new_path.call(null,tail_node.arr,root_edit,(shift_2383__$1 - (5)),tail_node));
}
}
break;
}
...
var shift_2393__$1 = shift;
var node_2394__$1 = node;
while(true){
if((shift_2393__$1 === (0))){
var arr_2395 = node_2394__$1.arr;
(arr_2395[(i & (31))] = val);
} else {
var arr_2396 = node_2394__$1.arr;
var subidx_2397 = ((i >> shift_2393__$1) & (31));
var child_2398 = clojure.core.rrb_vector.nodes.clone.call(null,shift_2393__$1,(arr_2396[subidx_2397]));
(arr_2396[subidx_2397] = child_2398);

var G__2399 = (shift_2393__$1 - (5));
var G__2400 = child_2398;
shift_2393__$1 = G__2399;
node_2394__$1 = G__2400;
continue;
}
break;
}
