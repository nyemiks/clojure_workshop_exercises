...
return clojure.test.check.random.longs.bit_xor.call(null,G__3457,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__3457;
}
});
...
var G__3460 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__3461 = cljs.core.conj_BANG_.call(null,ret,new_rng);
state__$1 = G__3460;
ret = G__3461;
continue;
}
...
return (function (p__3462){
var map__3463 = p__3462;
var map__3463__$1 = (((((!((map__3463 == null))))?(((((map__3463.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3463.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3463):map__3463);
var state = cljs.core.get.call(null,map__3463__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__3465 = clojure.test.check.random.split.call(null,state);
var r1 = cljs.core.nth.call(null,vec__3465,(0),null);
var r2 = cljs.core.nth.call(null,vec__3465,(1),null);
