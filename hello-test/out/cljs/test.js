...
var G__2225 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__2225,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__2225;
}
});
...
var len__4730__auto___2230 = arguments.length;
var i__4731__auto___2231 = (0);
while(true){
if((i__4731__auto___2231 < len__4730__auto___2230)){
args__4736__auto__.push((arguments[i__4731__auto___2231]));

var G__2232 = (i__4731__auto___2231 + (1));
i__4731__auto___2231 = G__2232;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq2227){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__2228,G__2229,seq2227__$2);
});
...
var map__2234 = m;
var map__2234__$1 = (((((!((map__2234 == null))))?(((((map__2234.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2234.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2234):map__2234);
var file = cljs.core.get.call(null,map__2234__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__2234__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__2234__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__2234,map__2234__$1,file,line,column){
return (function (p1__2233_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__2233_SHARP_));
});})(map__2234,map__2234__$1,file,line,column))
...
var temp__5720__auto___2236 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___2236)){
var message_2237 = temp__5720__auto___2236;
cljs.core.println.call(null,message_2237);
} else {
}
...
var temp__5720__auto___2238 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___2238)){
var message_2239 = temp__5720__auto___2238;
cljs.core.println.call(null,message_2239);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__2240 = output_dir;
...
var G__2242 = exception.stack;
var G__2242__$1 = (((G__2242 == null))?null:clojure.string.split_lines.call(null,G__2242));
var G__2242__$2 = (((G__2242__$1 == null))?null:cljs.core.get.call(null,G__2242__$1,depth));
if((G__2242__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__2242__$2);
}
} else {
...
var vec__2243 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__2243,(0),null);
var column = cljs.core.nth.call(null,vec__2243,(1),null);
var vec__2246 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__2246,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__2246,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__2246,(2),null);
...
var m__$1 = (function (){var G__2249 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__2253 = (function (){var G__2252 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__2252);
} else {
return G__2252;
}
})();
...
return cljs.core.vary_meta.call(null,G__2254,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e2255){var e = e2255;
var G__2256 = e;
var G__2256__$1 = (((G__2256 instanceof cljs.core.Keyword))?G__2256.fqn:null);
switch (G__2256__$1) {
...
var vec__2258 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__2258,(0),null);
var types = vec__2258;
...
return cljs.core.map.call(null,(function (p__2261){
var vec__2262 = p__2261;
var ns = cljs.core.nth.call(null,vec__2262,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__2262,(1),null);
return ((function (vec__2262,ns,vars__$1){
return (function (){
...
var G__2265 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1){
return (function (){
var seq__2266 = cljs.core.seq.call(null,vars__$1);
var chunk__2267 = null;
var count__2268 = (0);
var i__2269 = (0);
while(true){
if((i__2269 < count__2268)){
var v = cljs.core._nth.call(null,chunk__2267,i__2269);
var temp__5720__auto___2271 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___2271)){
var t_2272 = temp__5720__auto___2271;
each_fixture_fn.call(null,((function (seq__2266,chunk__2267,count__2268,i__2269,t_2272,temp__5720__auto___2271,v,each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2272)));
});})(seq__2266,chunk__2267,count__2268,i__2269,t_2272,temp__5720__auto___2271,v,each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1))
);
} else {
}


var G__2273 = seq__2266;
var G__2274 = chunk__2267;
var G__2275 = count__2268;
var G__2276 = (i__2269 + (1));
seq__2266 = G__2273;
chunk__2267 = G__2274;
count__2268 = G__2275;
i__2269 = G__2276;
...
var temp__5720__auto__ = cljs.core.seq.call(null,seq__2266);
if(temp__5720__auto__){
var seq__2266__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2266__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__2266__$1);
var G__2277 = cljs.core.chunk_rest.call(null,seq__2266__$1);
var G__2278 = c__4550__auto__;
var G__2279 = cljs.core.count.call(null,c__4550__auto__);
var G__2280 = (0);
seq__2266 = G__2277;
chunk__2267 = G__2278;
count__2268 = G__2279;
...
var v = cljs.core.first.call(null,seq__2266__$1);
var temp__5720__auto___2281__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___2281__$1)){
var t_2282 = temp__5720__auto___2281__$1;
each_fixture_fn.call(null,((function (seq__2266,chunk__2267,count__2268,i__2269,t_2282,temp__5720__auto___2281__$1,v,seq__2266__$1,temp__5720__auto__,each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_2282)));
});})(seq__2266,chunk__2267,count__2268,i__2269,t_2282,temp__5720__auto___2281__$1,v,seq__2266__$1,temp__5720__auto__,each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1))
);
} else {
}


var G__2283 = cljs.core.next.call(null,seq__2266__$1);
var G__2284 = null;
var G__2285 = (0);
var G__2286 = (0);
seq__2266 = G__2283;
...
});})(each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1))
);
});})(each_fixture_fn,G__2265,G__2265__$1,env,once_fixtures,each_fixtures,vec__2262,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__2265__$1)].join('')));

}
})());
});
;})(vec__2262,ns,vars__$1))
