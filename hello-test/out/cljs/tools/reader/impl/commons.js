...
var G__3220 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__3220;
continue;
} else {
return ch;
...
var vec__3221 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__3221,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq3224){
...
return (function() { 
var G__3229__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__3229 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__3230__i = 0, G__3230__a = new Array(arguments.length -  1);
while (G__3230__i < G__3230__a.length) {G__3230__a[G__3230__i] = arguments[G__3230__i + 1]; ++G__3230__i;}
  _ = new cljs.core.IndexedSeq(G__3230__a,0,null);
} 
return G__3229__delegate.call(this,rdr,_);};
G__3229.cljs$lang$maxFixedArity = 1;
G__3229.cljs$lang$applyTo = (function (arglist__3231){
var rdr = cljs.core.first(arglist__3231);
var _ = cljs.core.rest(arglist__3231);
return G__3229__delegate(rdr,_);
});
