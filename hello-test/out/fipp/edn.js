...
fipp.edn.pretty_coll = (function fipp$edn$pretty_coll(p__2761,open,xs,sep,close,f){
var map__2762 = p__2761;
var map__2762__$1 = (((((!((map__2762 == null))))?(((((map__2762.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__2762.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__2762):map__2762);
var printer = map__2762__$1;
var print_level = cljs.core.get.call(null,map__2762__$1,new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
var print_length = cljs.core.get.call(null,map__2762__$1,new cljs.core.Keyword(null,"print-length","print-length",1931866356));
var printer__$1 = (function (){var G__2764 = printer;
if(cljs.core.truth_(print_level)){
return cljs.core.update.call(null,G__2764,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),cljs.core.dec);
} else {
return G__2764;
}
})();
var xform = cljs.core.comp.call(null,(cljs.core.truth_(print_length)?cljs.core.take.call(null,print_length):cljs.core.identity),cljs.core.map.call(null,((function (printer__$1,map__2762,map__2762__$1,printer,print_level,print_length){
return (function (p1__2760_SHARP_){
return f.call(null,printer__$1,p1__2760_SHARP_);
});})(printer__$1,map__2762,map__2762__$1,printer,print_level,print_length))
...
fipp.edn.EdnPrinter.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4387__auto__,k2766,else__4388__auto__){
var self__ = this;
var this__4387__auto____$1 = this;
var G__2770 = k2766;
var G__2770__$1 = (((G__2770 instanceof cljs.core.Keyword))?G__2770.fqn:null);
switch (G__2770__$1) {
case "symbols":
...
break;
default:
return cljs.core.get.call(null,self__.__extmap,k2766,else__4388__auto__);
...
return (function (ret__4407__auto__,p__2771){
var vec__2772 = p__2771;
var k__4408__auto__ = cljs.core.nth.call(null,vec__2772,(0),null);
var v__4409__auto__ = cljs.core.nth.call(null,vec__2772,(1),null);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__2765){
var self__ = this;
var G__2765__$1 = this;
return (new cljs.core.RecordIter((0),G__2765__$1,4,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator.call(null,self__.__extmap):cljs.core.nil_iter.call(null))));
});
...
fipp.edn.EdnPrinter.prototype.fipp$visit$IVisitor$visit_tagged$arity$2 = (function (this$,p__2775){
var self__ = this;
var map__2776 = p__2775;
...
var tag = cljs.core.get.call(null,map__2776__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var form = cljs.core.get.call(null,map__2776__$1,new cljs.core.Keyword(null,"form","form",-1624062471));
var this$__$1 = this;
...
return (function (printer,p__2778){
var vec__2779 = p__2778;
var k = cljs.core.nth.call(null,vec__2779,(0),null);
var v = cljs.core.nth.call(null,vec__2779,(1),null);
...
fipp.edn.EdnPrinter.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this2767,other2768){
var self__ = this;
var this2767__$1 = this;
return (((!((other2768 == null)))) && ((this2767__$1.constructor === other2768.constructor)) && (cljs.core._EQ_.call(null,this2767__$1.symbols,other2768.symbols)) && (cljs.core._EQ_.call(null,this2767__$1.print_meta,other2768.print_meta)) && (cljs.core._EQ_.call(null,this2767__$1.print_length,other2768.print_length)) && (cljs.core._EQ_.call(null,this2767__$1.print_level,other2768.print_level)) && (cljs.core._EQ_.call(null,this2767__$1.__extmap,other2768.__extmap)));
});
...
fipp.edn.EdnPrinter.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4392__auto__,k__4393__auto__,G__2765){
var self__ = this;
var this__4392__auto____$1 = this;
var pred__2782 = cljs.core.keyword_identical_QMARK_;
var expr__2783 = k__4393__auto__;
if(cljs.core.truth_(pred__2782.call(null,new cljs.core.Keyword(null,"symbols","symbols",1211743),expr__2783))){
return (new fipp.edn.EdnPrinter(G__2765,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2782.call(null,new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),expr__2783))){
return (new fipp.edn.EdnPrinter(self__.symbols,G__2765,self__.print_length,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2782.call(null,new cljs.core.Keyword(null,"print-length","print-length",1931866356),expr__2783))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,G__2765,self__.print_level,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_(pred__2782.call(null,new cljs.core.Keyword(null,"print-level","print-level",-1825423733),expr__2783))){
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,G__2765,self__.__meta,self__.__extmap,null));
} else {
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,self__.__meta,cljs.core.assoc.call(null,self__.__extmap,k__4393__auto__,G__2765),null));
}
}
}
}
...
fipp.edn.EdnPrinter.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4384__auto__,G__2765){
var self__ = this;
var this__4384__auto____$1 = this;
return (new fipp.edn.EdnPrinter(self__.symbols,self__.print_meta,self__.print_length,self__.print_level,G__2765,self__.__extmap,self__.__hash));
});
 ...
 */
fipp.edn.map__GT_EdnPrinter = (function fipp$edn$map__GT_EdnPrinter(G__2769){
var extmap__4424__auto__ = (function (){var G__2785 = cljs.core.dissoc.call(null,G__2769,new cljs.core.Keyword(null,"symbols","symbols",1211743),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598),new cljs.core.Keyword(null,"print-length","print-length",1931866356),new cljs.core.Keyword(null,"print-level","print-level",-1825423733));
if(cljs.core.record_QMARK_.call(null,G__2769)){
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,G__2785);
} else {
return G__2785;
}
})();
return (new fipp.edn.EdnPrinter(new cljs.core.Keyword(null,"symbols","symbols",1211743).cljs$core$IFn$_invoke$arity$1(G__2769),new cljs.core.Keyword(null,"print-meta","print-meta",1034114598).cljs$core$IFn$_invoke$arity$1(G__2769),new cljs.core.Keyword(null,"print-length","print-length",1931866356).cljs$core$IFn$_invoke$arity$1(G__2769),new cljs.core.Keyword(null,"print-level","print-level",-1825423733).cljs$core$IFn$_invoke$arity$1(G__2769),null,cljs.core.not_empty.call(null,extmap__4424__auto__),null));
});

fipp.edn.pprint = (function fipp$edn$pprint(var_args){
var G__2788 = arguments.length;
switch (G__2788) {
case 1:
...
var _STAR_print_meta_STAR__orig_val__2789 = cljs.core._STAR_print_meta_STAR_;
var _STAR_print_meta_STAR__temp_val__2790 = false;
cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__temp_val__2790;

try{return fipp.engine.pprint_document.call(null,fipp.visit.visit.call(null,printer,x),options);
}finally {cljs.core._STAR_print_meta_STAR_ = _STAR_print_meta_STAR__orig_val__2789;
}});
